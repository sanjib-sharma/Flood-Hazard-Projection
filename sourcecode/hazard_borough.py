...
'''
list_circles = haz99_boro[['Latitude', 'Longitude', 'haz_2099']].dropna().values
...
fig.savefig('../maps/final_maps/hazard2099_boro_final.png', dpi=600, bbox_inches='tight')
